...
public class GoodsController {
    ...
    public String searchPage(@RequestParam Map<String, Object> params, HttpServletRequest request) {
        ...
        params.put("limit", Constant.GOODS_SEARCH_PAGE_LIMIT);
        //封装分类数据
        ...
        request.setAttribute("pageResult", goodsManageService.searchGoods(pageUtil));
        return "user/search";
    }
    ...
    public String detailPage(@PathVariable("goodsId") Long goodsId, HttpServletRequest request) {
        ...
        Goods goods = goodsManageService.queryGoodsById(goodsId);
        if (goods == null) {
            XYmallException.fail(ServiceResultEnum.GOODS_NOT_EXIST.getResult());
        }
        if (Constant.SELL_STATUS_UP != goods.getGoodsSellStatus()) {
            XYmallException.fail(ServiceResultEnum.GOODS_PUT_DOWN.getResult());
        }
